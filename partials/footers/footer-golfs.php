...
<!-- Begin: FOOTER -->
<!-- #footer -->
<footer id="colophon" class="site-footer site-footer--waff mt-0 pt-13 pt-md-20 pb-10 pb-md-18 bg-action-3 --text-light --link-light contrast--dark ---- bg-image bg-cover bg-position-center-center position-relative <?php echo esc_attr( $has_background ); ?>" <?php ($bg_image['url'] ? 'style="background-image: url('.$bg_image['url'].');"' : ''); ?>>
