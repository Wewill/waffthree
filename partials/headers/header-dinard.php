				...
				<div class="d-flex col flex-column align-items-stretch justify-content-center d-lg-block d-none pe-5 ps-4">
						...
						<?php if ( has_nav_menu( 'primary' ) ) : ?>
								...
								wp_nav_menu(
									array(
										...
										'depth'          => '3',
										'add_li_class'  	 => 'nav-link font-weight-bold px-4'
										// + le cas link-muted
					...
					<div class="ps-4 mt-2">
						<span class="d-flex edition-wrapper overflow-hidden position-relative">
							<span class="edition-number bg-white text-action-1 pe-1 font-weight-bold zi-4"><?php echo do_shortcode( '[getcurrenteditionsc]' ); ?></span>
							<span class="edition-dates text-sm text-action-1 font-weight-semi-bold"><span class="bullet bullet-action-1"></span> <?php echo do_shortcode( '[getcurrenteditionsc display="full"]' ); ?></span>
						</span>
					</div>
