					...
					<div class="img-shifted shift-left vh-50 md-min-h-460 <?= $mode; ?>">
						...
						<?php if (!empty($video)): ?>
							<figure class="wp-block-video h-100 bg-action-1">
								<video class="w-100 h-auto video-cover" autoplay loop playsinline src="<?= $video['src']; ?>" style="/* filter: grayscale(100%) brightness(0.6) contrast(1); mix-blend-mode: screen; */"></video>
							</figure>
						<?php endif; ?>
						</div>
					</div>
