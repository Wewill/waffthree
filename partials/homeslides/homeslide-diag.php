					...
					?>
						...
						<div class="d-flex flex-column justify-content-end bg-gradient-action-1 border-0 --text-dark vh-100 min-h-600-px position-relative" data-post-id="<?= $slide_id; ?>" data-slide-id="<?= $slide_nb; ?>" data-slide-title="<?= $slide_title; ?>" <?= $style; ?>>
							...
							<div class="ps-3 ps-md-5 py-1">
								<h1 class="f-20 <?= $class ?> w-60"><?= WaffTwo\Core\waff_do_markdown($_slide_title); ?></h1>
							</div>
							<div class="ps-3 ps-md-5 pb-3 --pt-1 opacity-50">
								<div class="mb-1 d-none d-sm-block <?= $class ?> w-60"><?= do_shortcode($content); ?></div>
			...
			<div class="d-flex align-items-center justify-content-between h-100">
				...
				<div class="flex-equal text-start">
					<div class="d-flex flex-column w-75">
						<a class="bg-action-3 color-action-1 py-3 px-5 py-sm-4 px-sm-9 rounded-start rounded-pill text-white h4 text-end" href="https://portail.diag-imagerie.fr/xaportaildiffusionmobile/#/LoginPortail/" target="_blank">Prendre rendez-vous</a>
						<a class="bg-color-gray py-3 px-5 py-sm-4 px-sm-9 rounded-start rounded-pill text-white h4 text-end" href="https://portail.diag-imagerie.fr/xaportaildiffusionmobile/#/LoginPortail/" target="_blank">Faire mon pré-accueil</a>
						<a class="bg-light-action-2 py-3 px-5 py-sm-4 px-sm-9 rounded-start rounded-pill text-white h4 text-end" href="https://portail.diag-imagerie.fr/xaportaildiffusionmobile/#/LoginPortail/" target="_blank">Consulter mes résultats</a>				
						<a class="bg-action-2 py-3 px-5 py-sm-4 px-sm-9 rounded-start rounded-pill text-white h4 text-end" href="https://portail.diag-imagerie.fr/xaportaildiffusionmobile/#/LoginPortail/" target="_blank">Régler en ligne</a>				
					</div>
				</div>
