			...
			<div class="row g-0 align-items-center">
				...
				<div class="col-12">
					...
					<div class="d-flex justify-content-between align-items-center">
						<div class="ms-5 me-2 --m-gutter-l flash-title --headline font-weight-bold text-nowrap badge badge-sm rounded-pill bg-color-gray text-light d-none d-sm-block"><?= esc_html__( 'Breaking', 'waff' ) ?><!-- Le flash--> <span class="sr-only"><?= esc_html__( 'Breaking news live from festival', 'waff' ) ?></span></div> <!-- <?= esc_html__( 'Read More', 'waff' ) ?> -->
