		...
		<div class="container-fluid px-0">
			<div class="row g-0 align-items-center">
				...
				<div class="col-auto col-xl-2 d-none d-xl-block bg-primary--- bg-action-1 text-center text-light link-light">
					<div class="p-2"><a href="" class="prog-title headline border-0 link fs-6" data-bs-toggle="modal" data-bs-target="#programmationModal" aria-expanded="false" aria-controls="programmationModal"><i class="fas fa-bolt me-2 --d-none transition-shake"></i> <?= esc_html__( 'Planning', 'waff' ) ?></a></div>
				</div>
