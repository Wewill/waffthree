...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  wp.customize( 'telephone', function( value ) {
	  value.bind( function( newval ) {
	    $( '#telephone' ).html( newval );
	  } );
	} );

	wp.customize( 'site_message', function( value ) {
	  value.bind( function( newval ) {
	    $( '#site_message' ).html( newval );
	  } );
	} );
	...
	wp.customize( 'privacy_statement', function( value ) {
	  value.bind( function( newval ) {
	    $( '#privacy_statement' ).html( newval );
	  } );
	} );
