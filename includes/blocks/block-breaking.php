					...
					<div class="card bg-transparent border-0 text-white --h-100 px-4 py-4 px-md-8 py-md-6 d-flex flex-column justify-content-between align-items-start z-2 <?= $is_preview ? '' : 'h-100' ?>">
						...
						<div class="w-100">
							<div class="w-100 w-lg-50">
								...
								<h2 class="card-title"><a href="<?php echo esc_url( mb_get_block_field( 'waff_b_moreurl_1' )); ?>" class=" link-white text-hover-color-light"><?= mb_get_block_field( 'waff_b_title_1' ) ?></a></h2>
							</div>
							<div class="card-text --fw-bold mt-4"><?= waff_do_markdown(mb_get_block_field( 'waff_b_content_1' )) ?></div>
							<?php if ( mb_get_block_field( 'waff_b_morelink_1' ) == 1 ) : ?>
							<a class="btn btn-action-3 btn-lg mt-4 stretched-link btn-transition-scale" href="<?php echo esc_url( mb_get_block_field( 'waff_b_moreurl_1' )); ?>"><?php esc_html_e( 'More...', 'waff' ); ?></a>
							<?php endif; ?>
						</div>
					</div>
					...
					<div class="card bg-transparent border-0 text-white --h-100 px-4 py-4 px-md-8 py-md-6 d-flex flex-column justify-content-between align-items-start z-2 <?= $is_preview ? '' : 'h-100' ?>">
						...
						<div class="w-100">
							<div class="w-100 w-lg-50">
								...
								<h3 class="card-title"><a href="<?php echo esc_url( mb_get_block_field( 'waff_b_moreurl_2' )); ?>" class="link-white text-hover-color-light"><?= mb_get_block_field( 'waff_b_title_2' ) ?></a></h3>
							</div>
							<div class="card-text --fw-bold mt-4"><?= waff_do_markdown(mb_get_block_field( 'waff_b_content_2' )) ?></div>
							<?php if ( mb_get_block_field( 'waff_b_morelink_2' ) == 1 ) : ?>
							<a class="btn btn-action-3 btn-lg mt-4 stretched-link btn-transition-scale" href="<?php echo esc_url( mb_get_block_field( 'waff_b_moreurl_2' )); ?>"><?php esc_html_e( 'More...', 'waff' ); ?></a>
							<?php endif; ?>
						</div>
					</div>
