					...
					<div class="modal-header sticky-top container-fluid">
							<div class="row g-0 align-items-center">
								<div class="col-md-5 col-lg-7 d-none d-md-block">
									<a class="close-icon color-white lead ml-5" data-bs-dismiss="modal" aria-label="Close">
...
?>
										...
										foreach($the_day_room['projections'] as $key => $the_day_room_projections) {
											//if ( $the_day_room_projections['has_films'] === true ) {
												...
												if (array_key_exists('f_sections', $the_day_room_projections) && is_array($the_day_room_projections['f_sections'])) foreach($the_day_room_projections['f_sections'] as $f_section) {
													...
													$html_f_section .= sprintf('<a href="%s" %s class="dot-section" data-bs-toggle="tooltip" data-container=".modal" data-title="%s" data-original-title="" title="">•</a>',
												...
												if ( $the_day_room_projections['p_young_public'] != '' ) 	$html_f_tags .= ' <i class="icon icon-young" data-toggle="tooltip" data-bs-toggle="tooltip" data-container=".modal-body" title="Parents-enfants"></i>'; 
												if ( $the_day_room_projections['p_is_guest'] != '' ) 		$html_f_tags .= ' <i class="icon icon-guest" data-toggle="tooltip" data-bs-toggle="tooltip" data-bs-html="true" data-html="true" data-container=".modal-body" title="En présence de • <strong>'.$the_day_room_projections['p_e_guest_contact'].'</strong>"></i>'; 
												if ( $the_day_room_projections['p_highlights'] != '' )		$html_f_tags .= ' <i class="icon icon-sun" data-toggle="tooltip" data-bs-toggle="tooltip" data-container=".modal-body" title="Temps-fort"></i>'; 
												if ( $the_day_room_projections['p_tag'] != '' ) 			$html_f_tags .= ' <i class="icon icon-warning text-danger" data-toggle="tooltip" data-bs-toggle="tooltip" data-bs-html="true" data-html="true" data-container=".modal-body" title="'.$the_day_room_projections['p_tag'].'"></i>'; 
		...
		?>
			...
			<div class="modal-footer container-fluid d-none d-xl-flex">
				<?php if (get_theme_mod( 'planning_url')) : ?><a href="<?php WaffTwo\display_planning_url(); ?>" class="btn btn-link text-decoration-none link-white color-white mx-4"><i class="icon icon-time f-24 lh-48"></i> <span class="subline d-block"><?= esc_html__( 'Planner', 'waff' ) ?> *.pdf</span></a><?php endif; ?>
				<?php if (get_theme_mod( 'booklet_url')) : ?><a href="<?php WaffTwo\display_booklet_url(); ?>" class="btn btn-link text-decoration-none link-white color-white mx-4"><i class="icon icon-brochure f-24 lh-48"></i> <span class="subline d-block"><?= esc_html__( 'Booklet', 'waff' ) ?> *.pdf</span></a><?php endif; ?>
				<?php if (get_theme_mod( 'catalog_url')) : ?><a href="<?php WaffTwo\display_catalog_url(); ?>" class="btn btn-link text-decoration-none link-white color-white mx-4"><i class="icon icon-catalogue f-24 lh-48"></i> <span class="subline d-block"><?= esc_html__( 'Book', 'waff' ) ?></span></a><?php endif; ?>
			</div>
			</div>
		</div>
		</div>
