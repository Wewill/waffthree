	...
	<div class="row punchlines" data-section-id="<?= $section_id ?>">
		...
		<div class="col-12 col-lg-10">
			...
			<p class="mb-0 mb-sm-4">
				...
				<?php else : ?>
				<!-- Standard buttons -->
				<a data-bs-toggle="modal" data-bs-target="#programmationModal" aria-expanded="false" aria-controls="programmationModal" href="#" class="btn btn-action-1 rounded-0"><i class="fas fa-bolt me-2 --d-none"></i> <?= __('Planning', 'waff') ?></a>
